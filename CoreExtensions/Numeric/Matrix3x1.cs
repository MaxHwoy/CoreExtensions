...
namespace CoreExtensions.Numeric
{
	...
	public struct Matrix3x1 : IMatrix, IEquatable<Matrix3x1>
	{
			...
			get
			{
				if (column == 1)
				{
					...
					switch (row)
					{
						...
						default: throw new ArgumentOutOfRangeException(nameof(row), "Row index should be in range 1 to 3");
					}
		...
		public Matrix3x1 Clone() => new Matrix3x1(this);
		public override bool Equals(object obj) => obj is Matrix3x1 matrix && this == matrix;
		public bool Equals(Matrix3x1 matrix) => this == matrix;
		public override int GetHashCode() => HashCode.Combine(this.Value11, this.Value21, this.Value31);
		public Matrix1x3 Transpose() => new Matrix1x3(this.Value11, this.Value21, this.Value31);
		IMatrix IMatrix.Transpose() => this.Transpose();
		public override string ToString() => this.ToString(null);
		public string ToString(string format) => Matrix.ToString(this, format);

		public static bool operator ==(Matrix3x1 a, Matrix3x1 b)
		{
			bool result = true;
		...
		{
			return new Matrix3x1(a.Value11 + b.Value11,
								 a.Value21 + b.Value21,
								 a.Value31 + b.Value31);
		}
		public static Matrix3x1 operator -(Matrix3x1 a, Matrix3x1 b)
		...
		public static Matrix3x1 operator *(Matrix3x1 m, float scalar)
		{
			return new Matrix3x1(m.Value11 * scalar,
								 m.Value21 * scalar,
								 m.Value31 * scalar);
		}
		public static Matrix3x1 operator *(Matrix3x1 m, int scalar)
		{
			return new Matrix3x1(m.Value11 * scalar,
								 m.Value21 * scalar,
								 m.Value31 * scalar);
		}
		public static Matrix3x1 operator *(float scalar, Matrix3x1 m) => m * scalar;
		public static Matrix3x1 operator *(int scalar, Matrix3x1 m) => m * scalar;
	}
}

...
namespace CoreExtensions.Numeric
{
	...
	public struct Matrix2x3 : IMatrix, IEquatable<Matrix2x3>
	{
		...
		public static Matrix2x3 operator *(float scalar, Matrix2x3 m) => m * scalar;
		public static Matrix2x3 operator *(int scalar, Matrix2x3 m) => m * scalar;
	}
}
